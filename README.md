...
```javascript
isSameValueZerof = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/complex-float32-base-assert-is-same-value-zero@umd/browser.js' )
```

To vendor stdlib functionality and avoid installing dependency trees for Node.js, you can use the UMD server build:

```javascript
var isSameValueZerof = require( 'path/to/vendor/umd/complex-float32-base-assert-is-same-value-zero/index.js' )
```
